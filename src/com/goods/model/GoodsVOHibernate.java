...
import com.report.model.ReportVOHibernate;

public class GoodsVOHibernate implements Serializable {
	private Integer gid;
	...
	private Set<ReportVOHibernate> reports = new HashSet<ReportVOHibernate>();

	public Set<ReportVOHibernate> getReports() {
		return reports;
	}

	public void setReports(Set<ReportVOHibernate> reports) {
		this.reports = reports;
	}

	public GoodsVOHibernate() {
	}

	public GoodsVOHibernate(Integer gid, Integer groupid, String member_id,
