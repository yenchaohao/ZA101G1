...
public class GoodsDAO implements Goods_interface {
	...
	private static final String GET_ALL_BY_MID = "SELECT gid,groupid,member_id,g_name,g_describe,g_price,g_level,g_hot, joindate,quitdate,pic,goods_status FROM ex_goods where goods_status != 2 and goods_status != 3 and  member_id = ?";	
	...
	private static final String GET_ALLAlive_STMT = "SELECT gid,groupid,member_id,g_name,g_describe,g_price,g_level,g_hot, joindate, quitdate,pic,goods_status FROM ex_goods where goods_status = 1 order by joindate";
